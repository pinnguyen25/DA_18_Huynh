...
namespace DA_18_Huynh
{
    ...
    {
        // Khai báo các biến driver và dịch vụ cho ChromeDriver
        ...
        //  nút "Mở Trình Duyệt"
        private void btnOpen_18_Click(object sender, EventArgs e)
        {
        ...
        //nút "Tìm Kiếm"
        private void btnSearch_18_Click(object sender, EventArgs e)
        {
        ...
        // nút "Quay Lại"
        private void btnBack_18_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        //nút "Chọn Truyện"
        private void btnChon_18_Click(object sender, EventArgs e)
        {
            if (chromeDriver == null)
            {
                MessageBox.Show("Vui lòng mở trình duyệt trước.");
        ...
        // nút "Đọc từ đầu"
        private void btnF_18_Click(object sender, EventArgs e)
        {
            try
            {
                // Tìm nút đọc từ đầu
        ...
        //nút "Đọc mới nhất"
        private void btnN_18_Click(object sender, EventArgs e)
        {
            try
            {
